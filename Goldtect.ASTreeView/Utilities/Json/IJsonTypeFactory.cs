...
namespace Goldtect.Utilities.Json
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonObject"/>.
        /// </summary>
        /// <returns>A <see cref="Goldtect.Utilities.Json.IJsonObject"/>.</returns>
        IJsonObject CreateObject();

        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonArray"/>.
        /// </summary>
        /// <returns>A <see cref="Goldtect.Utilities.Json.IJsonArray"/>.</returns>
        IJsonArray CreateArray();

        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonString"/> representing
        /// the specified <paramref name="value"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>a <see cref="Goldtect.Utilities.Json.IJsonString"/> representing
        /// the specified <paramref name="value"/></returns>
        IJsonString CreateString(string value);

        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonNumber"/> representing
        /// the specified <paramref name="value"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>a <see cref="Goldtect.Utilities.Json.IJsonNumber"/> representing
        /// the specified <paramref name="value"/></returns>
        IJsonNumber CreateNumber(double value);

        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonBoolean"/> representing
        /// the specified <paramref name="value"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>a <see cref="Goldtect.Utilities.Json.IJsonBoolean"/> representing
        /// the specified <paramref name="value"/></returns>
        IJsonBoolean CreateBoolean(bool value);

        /// <summary>
        /// Creates a <see cref="Goldtect.Utilities.Json.IJsonNull"/>.
        /// </summary>
        /// <returns>A <see cref="Goldtect.Utilities.Json.IJsonNull"/>.</returns>
