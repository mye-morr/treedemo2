...
namespace Goldtect.Utilities.Json
{
    ...
    public sealed class JsonString : JsonTypeSkeleton, IJsonString
    {
        ...
        /// <summary>
        /// Returns a indicating whether this instance is equal to the specified
        /// <see cref="Goldtect.Utilities.Json.IJsonString"/>.
        /// </summary>
        /// <param name="other">The value to compare.</param>
        /// <returns>True if the specified instance is equal to this instance, otherwise;
        /// false.</returns>
        ...
        /// <see cref="Goldtect.Utilities.Json.IJsonString"/>.
        /// </summary>
        /// <param name="other">The <see cref="Goldtect.Utilities.Json.IJsonString"/> to 
        /// compare.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Determines if the two <see cref="Goldtect.Utilities.Json.JsonString"/>s are
        /// equal.
        /// </summary>
