...
namespace Goldtect.Utilities.Json
{
    ...
    public sealed class JsonBoolean : JsonTypeSkeleton, IJsonBoolean
    {
        ...
        /// <summary>
        /// Returns a indicating whether this instance is equal to the specified
        /// <see cref="Goldtect.Utilities.Json.IJsonBoolean"/>.
        /// </summary>
        /// <param name="other">The value to compare.</param>
        /// <returns>True if the specified instance is equal to this instance, otherwise;
        /// false.</returns>
        ...
        /// <summary>
        /// Implicit <see cref="Goldtect.Utilities.Json.JsonNull"/> conversion operator.
        /// </summary>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Explicit <see cref="Goldtect.Utilities.Json.JsonBoolean"/> conversion operator.
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
