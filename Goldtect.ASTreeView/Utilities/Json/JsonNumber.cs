...
namespace Goldtect.Utilities.Json
{
    ...
    public sealed class JsonNumber : JsonTypeSkeleton, IJsonNumber
    {
        ...
        /// <see cref="Goldtect.Utilities.Json.IJsonWriter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns a indicating whether this instance is equal to the specified
        /// <see cref="Goldtect.Utilities.Json.IJsonNumber"/>.
        /// </summary>
        /// <param name="other">The value to compare.</param>
        /// <returns>True if the specified instance is equal to this instance, otherwise;
        /// false.</returns>
        ...
        /// Returns a value indicating equality with the specified instance.
        /// </summary>
        /// <param name="other">The <see cref="Goldtect.Utilities.Json.IJsonNumber"/> to compare.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Determines if the two <see cref="Goldtect.Utilities.Json.JsonNumber"/>s are
        /// equal.
        /// </summary>
